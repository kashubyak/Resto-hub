...
export default function CategoryPage() {
	...
	const { allCategories, isLoading: isLoadingCategories, refetchCategories } =
		useCategories(searchQuery, filters)
	const { showError, showSuccess } = useAlert()
	const hasCategories = allCategories.length > 0
	const hasSearchOrFilters = !!searchQuery || Object.keys(filters).length > 0
	const showHeader = hasCategories || hasSearchOrFilters || isLoadingCategories
	...
	const handleEditCategory = useCallback(
		...
		[selectedCategory, showSuccess, showError, refetchCategories, handleEditModalClose],
	)
	...
	}, [selectedCategory, showSuccess, showError, refetchCategories, handleDeleteDialogClose])
