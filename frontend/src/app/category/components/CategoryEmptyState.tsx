...
import { Folder, Plus, Sparkles, Upload } from 'lucide-react'
			...
			<div className="w-full max-w-4xl text-center space-y-8 px-4">
				...
				<div className="space-y-3">
					...
					<p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
						Organize your dishes into categories for better navigation. You can
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto pt-4">
						...
						<div className="relative z-10 space-y-4">
							...
							<div>
								...
								<p className="text-sm sm:text-base text-white/80">
									Create categories one by one with full control
								</p>
							</div>
					...
					<button
						...
						disabled
						aria-label="Import categories (coming soon)"
					>
						<div className="relative z-10 space-y-4">
							...
							<div>
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Upload CSV or Excel file with your categories (Coming soon)
								</p>
							</div>
				...
				<div className="pt-4 space-y-3">
					<div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
						...
						<span>
							Pro tip: Use categories to organize dishes by type, cuisine, or
							meal time
						</span>
					</div>
...
export const CategoryEmptyState = memo(CategoryEmptyStateComponent)
