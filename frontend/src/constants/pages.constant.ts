...
export const ROUTES = {
	...
	PRIVATE: {
		...
		WAITER: {
			...
			ORDERS_WAITER_ID: (id: number | string) =>
				`${ROUTES.PRIVATE.WAITER.ORDERS_WAITER}/${id}`,
		},
	} as const,
} as const
...
export const ROLE_DEFAULT_ROUTE: Record<UserRole, string> = {
	[UserRole.ADMIN]: ROUTES.PRIVATE.SHARED.DASHBOARD,
	[UserRole.COOK]: ROUTES.PRIVATE.COOK.ORDERS_COOK,
	[UserRole.WAITER]: ROUTES.PRIVATE.WAITER.ORDERS_WAITER,
}
...
export const ROLE_ROUTES_MAP: Record<UserRole, string[]> = {
	...
	[UserRole.WAITER]: [
		...
		ROUTES.PRIVATE.WAITER.ORDERS_WAITER_HISTORY,
	],
}
